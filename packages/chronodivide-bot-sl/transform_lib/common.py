...
LABEL_LAYOUT_V2_VERSION = "v2"
TRAINING_TARGETS_V2_VERSION = "v2"
...
def parse_args(argv: list[str]) -> TransformConfig:
    ...
    parser.add_argument("--move-order-keep-prob", type=float, default=0.05)
    parser.add_argument("--gather-order-keep-prob", type=float, default=0.1)
    parser.add_argument("--attack-order-keep-prob", type=float, default=1.0)
